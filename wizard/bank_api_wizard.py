...
class bank_api_wizard(models.TransientModel):
    ...
    def get_bank_statement(self):
        if self.start_date > self.end_date:
            ...
            account_journal.bank_api_id.bca_procedure_get_bank_statement(account_journal.id,account_journal.bank_account_id.acc_number,self.start_date,self.end_date)
